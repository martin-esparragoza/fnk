...
int boot_vfs_init(void) {return BOOT_VFS_ERRC_OK;}
...
int boot_vfs_dir_enumerate(struct boot_vfs_dir* dir) {return BOOT_VFS_ERRC_OK;}
...
int boot_vfs_fini(void) {return BOOT_VFS_ERRC_OK;}